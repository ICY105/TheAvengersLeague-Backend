...
public class CustomGameCard extends Card {
	...
	public CustomGameCard(final int id, final int powerCost, final EAbilities ability, final int intelligence, final int strength,
			final int speed, final int durability, final int power, final int combat, final String name, final String imageUrl) {
		super(id, powerCost, ability, intelligence, strength, speed, durability, power, combat);
